...
export const GlassCard = ({ children, className, glow = "none", style }: GlassCardProps) => {
  return (
    <div
      style={style}
      className={cn(
        "group relative rounded-2xl border border-white/[0.04] bg-gradient-to-br from-white/[0.03] via-white/[0.02] to-white/[0.01] p-4 sm:p-6 lg:p-7 backdrop-blur-md transition-all duration-300 ease-out overflow-hidden",
        ...
        glow === "orange" && [
          "hover:border-white/15 hover:shadow-[0_0_60px_rgba(255,255,255,0.12),0_8px_32px_rgba(0,0,0,0.4)]",
        ...
        glow === "cyan" && [
          "hover:border-white/12 hover:shadow-[0_0_50px_rgba(255,255,255,0.1),0_8px_32px_rgba(0,0,0,0.4)]",
          "hover:scale-[1.01] hover:-translate-y-0.5",
